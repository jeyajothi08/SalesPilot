    ...
    <div className="h-full flex flex-col p-8 space-y-6 relative">
      <div className="flex justify-between items-center">
        ...
        <button 
          ...
          className="px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-medium rounded-lg shadow-lg shadow-emerald-500/20 transition-colors cursor-pointer border-none"
        >
          + New Deal
        </button>
      </div>
            ...
            <form onSubmit={handleCreateDeal} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-black/60 border border-white/10 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-emerald-500"
                />
              </div>
