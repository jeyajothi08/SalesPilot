       ...
       <nav className="flex-1 px-4 py-6 space-y-1">
          ...
          {menuItems.map(item => (
            <a 
              ...
              href="#"
              className={`
                flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-medium transition-all relative group
          ...
          <a href="#" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-ds-text-secondary hover:text-ds-text-primary hover:bg-ds-surface-hover transition-all">
