...
class SalesAgentOrchestrator:
    ...
    def _build_agent():
        ...
        agent = create_react_agent(llm, tools=AGENT_TOOLS, prompt=SALES_AGENT_SYSTEM_PROMPT)
        return agent
    ...
    async def chat(cls, session_id: str, message: str, history: List[BaseMessage]) -> Dict[str, Any]:
        ...
        try:
            ...
            if msg_lower in ["hi", "hello", "hey", "greetings"]:
                reply = "Hello! I am SalesPilot AI Copilot. I can help analyze your pipeline, manage CRM leads, and automate your sales processes. How can I help you today?"
            elif "lead" in msg_lower or "deal" in msg_lower or "crm" in msg_lower:
                reply = "SalesPilot AI is connected to your CRM database. You can manage deals, track pipeline progress, and update contact status in your active workspace."
            else:
                reply = "Hello! I am SalesPilot AI Copilot. Your message has been received. (To use live OpenAI gpt-4o models, please set your OPENAI_API_KEY in backend/.env)."
